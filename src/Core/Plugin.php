...
/**
 * Bootstrap plugin class, declares the plugin entry point with wordpress.
 * It also registers all the child pages and some required libs
 * (3rd party software) to be loaded on the frontend. This class also contains
 * methods to uninstall, activate & deactivate the plugin.
 *
 * @author João Vieira
 * @license MIT
 */
